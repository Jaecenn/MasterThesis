...
%	supervisor-specialist = {John Doe},
	...
	keywords-english = {digital signal processing, textile defects, unevenness},
	day = 15,
	month = 5,
	year = 2016,
...
Hmotnostní nerovnoměrnost má významný vliv na kvalitu textilních vláken. Analyzováním nerovnoměrností vlákna je tak možné určit jeho kvalitu. Tato práce se zabývá algoritmem pro vyhodnocování kvality textilních vláken analyzováním jejich nerovnoměrnosti. Navržený algorithms pro digitalní zpracování signálu je založen na multi-rate analýze a je implementován jako software pro mikrokontroléry. Byly vyvinuty dva algoritmy založené na stejném principu, a to pro analýzu dvou typů textilních vláken: pramene a příze. Pro analýzu kvality textilního pramene byl také vyvinut vestavný systém za účelem měření průměru pramene a následného zpracování naměřeného signálu. Výsledkem analýzy je rozptylová křivka, která je použita jako měřítko kvality pramene. Pro vyhodnocení kvality příze byla naprogramována softwarová knihovna cílená pro mikrokontroléry. Provedené testy dokázali, že spektrogram, který je výstupem algoritmu, je schopný spolehlivě určit kvalitu příze.
\end{abstract-czech}

% Abstract in English
\begin{abstract-english}
Mass unevenness significantly affects a quality of the textile fibers. By analysing the unevenness of a fiber it is possible to determine its quality. This thesis describes algorithm for evaluation of the quality of the textile fibers by analysing their unevenness. Designed digital signal processing algorithm is based on a multi-rate analysis and is implemented as software targeted for general-purpose microcontrollers. Two algorithms based on the same basis were developed for an analysis of the two textile fiber types: sliver and yarn.  For the analysis of a sliver quality an embedded device is developed for measuring the diameter of the sliver and subsequent processing of the measured signal. Result of the analysis is variance-length curve, which is used as a measure of the sliver quality. For the quality evaluation of the yarn a software library, targeted for microcontrollers, is developed. Executed tests proved that a spectrogram, which is the output of the algorithm, can reliably determine the quality of the yarn.

\end{abstract-english}

% Acknowledgements / Podekovani
\begin{thanks}
I would like to thank my supervisor Ing. Jakub Parák without whose guidance this thesis could not be written. I would also like to thank Ing. Pavel Kousalík, Ph.D. from Rieter CZ s.r.o, for providing me with invaluable advices and support. And, of course, I would like to thank my family and all the people who supported me during the writing.
\end{thanks}

% Declaration / Prohlaseni
\begin{declaration}
Některé skutečnosti, uvedené v této práci, jsou předmětem obchodního tajemství Rieter CZ,
popř. koncernu RIETER ve smyslu ustanovení § 17 a následujících zákona č.513/1991 Sb. ve
znění pozdějších změn a doplňků (Obchodní zákoník).
Bez souhlasu Rieter CZ s.r.o. lze tyto informace použít pouze v souladu s platnými předpisy,
týkajícími se magisterského studia.
RIETER si vyhrazuje veškerá práva k předmětům duševního vlastnictví, týkajících se zde
uvedených informací, zejména pro ochranné přihlášky předmětů průmyslových práv a
poukazuje výslovně na to, že jejich případné zveřejnění nebo poskytnutí třetí osobě
představuje zřejmé zneužití ve smyslu §5 zákona č. 527/1990 Sb.(Zákon o vynálezech). 
\vfill
Prohlašuji, že jsem předloženou práci vypracoval samostatně, a že jsem uvedl veškeré použité informační zdroje v souladu s Metodickým pokynem o dodržování etických principů při přípravě vysokoškolských závěřečných prací.
\bigskip
