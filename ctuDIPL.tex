...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{frequencyFiltration.eps}
...
Another options are available for setting in the application that are designated only as parameters for the application itself.
\begin{itemize}
	\setlength{\itemsep}{5pt}
