...
\begin{thanks}
I would like to thank my supervisor Ing. Jakub Parák without whose guidance this thesis could not be written. I would also like to thank Ing. Pavel Kousalík, Ph.D. from Rieter CZ s.r.o, for providing me with invaluable advice and support. And, of course, I would like to thank my family and all the people who supported me during the writing.
\end{thanks}
...
%The length N of the DFT should be larger than L = T0/T to obtain a good visual representation of DTFT. If we set N to the power of two N=2^Q, fft calculation %done microcontroller is executed faster.
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=1.0\linewidth]{sliverGood.jpg}
